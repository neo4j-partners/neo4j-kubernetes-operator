...
Instead, report them via [GitHub Security Advisories](https://github.com/neo4j-partners/neo4j-kubernetes-operator/security/advisories/new).
...
- Container images published to `ghcr.io/neo4j-partners/neo4j-kubernetes-operator`
