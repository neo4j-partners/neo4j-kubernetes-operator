...
func TestApplyScheduling(t *testing.T) {
	neo4j := &neo4jv1.Neo4j{
		...
		Spec: neo4jv1.Neo4jSpec{
			...
			Scheduling: &neo4jv1.SchedulingSpec{
				...
				Affinity: &neo4jv1.SchedulingAffinitySpec{PodAntiAffinity: "hard"},
...
func TestApplySchedulingSoftAntiAffinity(t *testing.T) {
	neo4j := &neo4jv1.Neo4j{
		...
		Spec: neo4jv1.Neo4jSpec{
			...
			Topology: neo4jv1.TopologySpec{Mode: neo4jv1.TopologyModeStandalone},
			Scheduling: &neo4jv1.SchedulingSpec{
				Affinity: &neo4jv1.SchedulingAffinitySpec{PodAntiAffinity: "soft"},
			},
			Storage: &neo4jv1.StorageSpec{
				Volumes: &neo4jv1.VolumesSpec{
					Data: neo4jv1.DataVolumeSpec{
