...
### Basic Database
- `single-node-database.yaml` - Simple database on single server
- `multi-server-database.yaml` - Database distributed across multiple servers
- `database-with-initial-data.yaml` - Database with initial Cypher data
