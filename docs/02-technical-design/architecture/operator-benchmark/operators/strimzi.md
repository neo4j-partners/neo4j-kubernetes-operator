...
| ------------------- | ------------------------------------------------------------------------------------------------------ |
| **Tier**            | 1                                                                                                      |
| **Repo**            | [https://github.com/strimzi/strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) |
...
**Neo4j takeaway**: Strimzi is **not a Go dependency reference**. Use CNPG/ECK for controller-runtime pins. Strimzi informs **CRD design, RBAC, scope, and test strategy** only. Implementation language is **Go** ([ADR-011](../../../decision-records/architecture/011-implementation-language.md)) — adopt Strimzi **patterns**, not the Vert.x/Java stack.
