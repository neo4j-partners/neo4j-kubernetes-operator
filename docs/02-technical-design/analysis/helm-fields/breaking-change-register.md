...
| BC-007 | Config passthrough vs allowlist | AGG-CONFIG-SURFACE | 4 | 4 | **16** | BDR-008 | accepted (Option A) |
| BC-008 | Pool ordinal / scale semantics | AGG-TOPO-ROLES | 5 | 3 | **15** | BDR-009 | accepted (Option B) |
...
| BDR-008 | Neo4j config surface — Option A passthrough | **accepted** | BC-007 |
| BDR-009 | Scale / pool ordinal semantics — Option B per-pool STS | **accepted** | BC-008 |
