...
| **`Neo4jUser`**, **`Neo4jRole`**, **`Neo4jGrant`** | TBD (post-V1 FRs) | **No** | **[BDR-012](../decision-records/business/012-identity-management.md)** — Option C proposed; folders `neo4juser/`, `neo4jrole/`, `neo4jgrant/` when V2+ scope locks. |
