...
| An AWS account | [Amazon EKS](aws-eks.md) — published chart, no Docker needed | ~30 min |
...
The four platform walkthroughs end at the same place: the operator running in
