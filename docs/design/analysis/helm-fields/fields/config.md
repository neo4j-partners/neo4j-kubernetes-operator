...
- **Notes**: Operator merges user map → topology-derived defaults → K8s discovery settings (BDR-002). **Option A** ([BDR-008](../../decision-records/business/008-neo4j-config-surface.md) accepted): full passthrough except reserved denylist.
