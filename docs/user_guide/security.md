...
If you want typed support (operator-managed keytab mount + generated config), [open an issue](https://github.com/neo4j-partners/neo4j-kubernetes-operator/issues) describing your use case.
