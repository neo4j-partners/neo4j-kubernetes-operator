...
More examples (GenAI, standalone targets, multi-plugin setups): [examples/plugins/](https://github.com/neo4j-partners/neo4j-kubernetes-operator/tree/main/examples/plugins).
...
- [Plugin examples](https://github.com/neo4j-partners/neo4j-kubernetes-operator/tree/main/examples/plugins) — APOC, GDS, Bloom, GenAI, cluster and standalone targets
